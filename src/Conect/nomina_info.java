...
import proyecto_final.principal;
/**
 *
 * @author Rocketer
 */
public class nomina_info extends javax.swing.JFrame {
 DefaultTableModel model = new DefaultTableModel();
    List<Datos> listaDatos = new ArrayList<>();
    
    int valormatricula;
    /**
     * Creates new form nomina_info
     */
    public nomina_info() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NOMBRE EMPLEADO", "PUESTO DE EMPLEADO", "CATEGORIA", "OCUPACION", "EMPRESA", "SALARIO"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        jLabel1.setText("INFORMACION DE LOS EMPLEADOS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nomina_info.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new nomina_info().setVisible(true);
            }
        });
    }
